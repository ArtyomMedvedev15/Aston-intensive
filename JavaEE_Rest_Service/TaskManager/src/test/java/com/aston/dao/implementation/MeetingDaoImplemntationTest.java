...
public class MeetingDaoImplemntationTest {
    ...
    public void CreateMeetingTest_ReturnTrue() {
        ...
        Long meetingSaveResult = meetingDaoImplemntation.createMeeting(meeting);
    ...
    public void DeleteMeetingTest_ReturnTrue() {
        ...
        Long meetingDeleteResult = meetingDaoImplemntation.deleteMeeting(meeting);
